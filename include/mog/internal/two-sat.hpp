#ifndef _MOG_INTERNAL_TWO_SAT_HPP_
#define _MOG_INTERNAL_TWO_SAT_HPP_

#include <mog/internal/graph/graph.hpp>
#include <mog/internal/graph/scc.hpp>
#include <mog/internal/graph/top-sort.hpp>
#include <mog/internal/permutations.hpp>
...
class TwoSat {
  public:
	...
	const std::vector<bool> &solution() { return value; }
