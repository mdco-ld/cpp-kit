...
template <class T>
using MinCntMonoid = internal::utils::traits::MinCntMonoid<T>;

template <class T>
using MaxCntMonoid = internal::utils::traits::MaxCntMonoid<T>;
...
template <class T> using OrMonoid = internal::utils::traits::OrMonoid<T>;
